...
from services.historiales import insert_historial, get_historial, update_historial, delete_historial

historiales_bp = Blueprint('historiales', __name__)


@historiales_bp.route('/historial', methods=['POST'])
def crear_historial():
...
@historiales_bp.route('/historial/<id>', methods=['GET'])
...
@historiales_bp.route('/historial/<id>', methods=['PUT'])
...
@historiales_bp.route('/historial/<id>', methods=['DELETE'])
