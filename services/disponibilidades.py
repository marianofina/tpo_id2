...
from functions.citas_x_turno import validator_medico
...
def disponibilidad_add():
    try:
        ...
        if validator_medico(data['horainicio_disp'], data['horafin_disp']):
            ...
            return jsonify({"message": "Horarios no válidos"}), 400
    except Exception as e:
        print(e)
...
def disponibilidad_modify():
    try:
        ...
        if 'id_disp' in data:
            ...
            return jsonify({"message": "Falta el id"}), 400
    except Exception as e:
        print(e)
